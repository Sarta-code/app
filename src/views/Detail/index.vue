        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="AttrList of spuSaleAttrList"
                  :key="AttrList.id">
                <dt class="title">{{AttrList.saleAttrName}}</dt>
                <dd changepirce="0"
                    v-for="(attrvalue) of AttrList.spuSaleAttrValueList"
                    :class="{ active: attrvalue.isChecked == 1 }"
                    v-on:click="attrvalueclick(attrvalue, AttrList.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:"
                   class="mins"
                   v-on:click="amount>1?amount--:1">-</a>
              </div>
              <div class="add">
                <a href="javascript:void(0)"
                   v-on:click="addShoppingCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
    ...
    methods: {
        attrvalueclick(attrvalue, spuSaleAttrValueList) {
